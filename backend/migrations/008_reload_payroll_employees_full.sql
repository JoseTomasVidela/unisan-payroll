-- Recarga completa de payroll_employees desde la base local.
-- Usar SOLO si Azure NO tiene datos dependientes en payroll_records, payroll_manual_adjustments o payroll_cell_overrides.
SET NAMES utf8mb4;
USE unisan_db;

-- Verificaciones previas recomendadas:
-- SELECT COUNT(*) FROM payroll_records;
-- SELECT COUNT(*) FROM payroll_manual_adjustments;
-- SELECT COUNT(*) FROM payroll_cell_overrides;
...
SELECT COUNT(*) AS total_workers_after_reload FROM payroll_employees;
SELECT COUNT(*) AS workers_with_rut_after_reload FROM payroll_employees WHERE rut IS NOT NULL AND TRIM(rut) <> ''; 
