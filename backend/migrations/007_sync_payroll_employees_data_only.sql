-- Sincroniza SOLO la data de payroll_employees hacia Azure/MySQL.
-- Requiere que las columnas ya existan en payroll_employees.
-- No toca payroll_cycles, payroll_imports, payroll_records ni liquidaciones.
SET NAMES utf8mb4;
USE unisan_db;
...
-- Si todo qued? bien, puedes eliminar la staging con esta l?nea:
